...
\ifinst\begin{instructions}
  \item Use this section to provide a list of relevant literature references. Do not refer readers to websites for additional information on your proposal. Do not introduce hyperlinks.
...
%% -------------------------------
%% Alliance Society: Public impact value proposition
%% (Delete this section if not applying for Alliance Society grant)
%% -------------------------------
\newpage
\section*{Alliance Society: Public impact value proposition}
\ifinst\begin{instructions}
  \item Describe the issue the project aims to address and explain the societal impact the project results will have. Describe the new technical knowledge that will be generated.
\end{instructions}\fi

\noindent Insert your text here, responding to the above point

\ifinst\begin{instructions}
  \item Describe the current barriers impeding a solution and the proposed novel strategy for addressing the issue. Explain why and how the research team and partner organizations are positioned to address the challenge.
\end{instructions}\fi

\noindent Insert your text here, responding to the above point

\ifinst\begin{instructions}
  \item Describe how the project is designed to take into account the needs of end-users and implementers. Outline the project's plan to involve groups in your partner organizations' network to achieve optimal results and impact.
\end{instructions}\fi

\noindent Insert your text here, responding to the above point

\ifinst\begin{instructions}
  \item Explain how the project outcomes will reach beyond the partner organizations to impact society. Describe the ways in which interested individuals or groups will be able to learn about and use the products, services or policies that stem from this research.
\end{instructions}\fi
